...
Está generado contra el commit **`9cb410d`**. **Si el código cambió desde
...
git diff --stat 9cb410d..HEAD -- '*.ts' '*.tsx' '*.js' '*.py'
...
- `graph.json` — grafo consultable. Al 11-ago-2026: **1.513 nodos y 2.714 aristas**, `graphify diagnose multigraph` sin duplicados ni variantes
  contradictorias.
