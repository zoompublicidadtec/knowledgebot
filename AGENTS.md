...
Está generado contra el commit **`42e04d3`**. **Si el código cambió desde
...
git diff --stat 42e04d3..HEAD -- '*.ts' '*.tsx' '*.js' '*.py'
...
- `graph.json` — grafo consultable. Al 03-ago-2026: **1.367 nodos y 2.391
