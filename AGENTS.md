...
Está generado contra el commit **`603ef8b`**. **Si el código cambió desde
...
git diff --stat 603ef8b..HEAD -- '*.ts' '*.tsx' '*.js' '*.py'
...
- `graph.json` — grafo consultable. Al 01-ago-2026: **1.360 nodos y 2.294
