...
Está generado contra el commit **`78632fa`**. **Si el código cambió desde
...
git diff --stat 78632fa..HEAD -- '*.ts' '*.tsx' '*.js' '*.py'
...
- `graph.json` — grafo consultable. Al 10-ago-2026: **1.454 nodos y 2.596 aristas**, `graphify diagnose multigraph` sin duplicados ni variantes
  contradictorias.
