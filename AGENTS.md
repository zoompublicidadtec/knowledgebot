...
Está generado contra el commit **`008ae8d`**. **Si el código cambió desde
...
git diff --stat 008ae8d..HEAD -- '*.ts' '*.tsx' '*.js' '*.py'
...
- `graph.json` — grafo consultable. Al 03-ago-2026: **1.418 nodos y 2.491
