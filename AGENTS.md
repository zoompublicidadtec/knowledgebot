...
Está generado contra el commit **`63f0c75`**. **Si el código cambió desde
...
git diff --stat 63f0c75..HEAD -- '*.ts' '*.tsx' '*.js' '*.py'
...
- `graph.json` — grafo consultable. Al 03-ago-2026: **1.422 nodos y 2.511
