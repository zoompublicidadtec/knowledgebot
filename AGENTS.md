...
Está generado contra el commit **`4aef1db`**. **Si el código cambió desde
...
git diff --stat 4aef1db..HEAD -- '*.ts' '*.tsx' '*.js' '*.py'
...
- `graph.json` — grafo consultable. Al 11-ago-2026: **1.487 nodos y 2.664 aristas**, `graphify diagnose multigraph` sin duplicados ni variantes
  contradictorias.
