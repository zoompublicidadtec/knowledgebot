...
Está generado contra el commit **`24756f4`**. **Si el código cambió desde
...
git diff --stat 24756f4..HEAD -- '*.ts' '*.tsx' '*.js' '*.py'
...
- `graph.json` — grafo consultable. Al 02-ago-2026: **1.365 nodos y 2.388
