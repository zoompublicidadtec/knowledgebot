...
Está generado contra el commit **`7ca0328`**. **Si el código cambió desde
...
git diff --stat 7ca0328..HEAD -- '*.ts' '*.tsx' '*.js' '*.py'
...
- `graph.json` — grafo consultable. Al 03-ago-2026: **1.371 nodos y 2.403
