...
Está generado contra el commit **`26fcf4b`**. **Si el código cambió desde
...
git diff --stat 26fcf4b..HEAD -- '*.ts' '*.tsx' '*.js' '*.py'
...
- `graph.json` — grafo consultable. Al 11-ago-2026: **1.489 nodos y 2.666 aristas**, `graphify diagnose multigraph` sin duplicados ni variantes
  contradictorias.
