...
Está generado contra el commit **`9456183`**. **Si el código cambió desde
...
git diff --stat 9456183..HEAD -- '*.ts' '*.tsx' '*.js' '*.py'
...
- `graph.json` — grafo consultable. Al 01-ago-2026: **1.359 nodos y 2.292
