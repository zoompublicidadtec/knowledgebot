...
Está generado contra el commit **`ee334d4`**. **Si el código cambió desde
...
git diff --stat ee334d4..HEAD -- '*.ts' '*.tsx' '*.js' '*.py'
...
- `graph.json` — grafo consultable. Al 02-ago-2026: **1.362 nodos y 2.381
