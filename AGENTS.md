...
Está generado contra el commit **`e295649`**. **Si el código cambió desde
...
git diff --stat e295649..HEAD -- '*.ts' '*.tsx' '*.js' '*.py'
...
- `graph.json` — grafo consultable. Al 11-ago-2026: **1.521 nodos y 2.737 aristas**, `graphify diagnose multigraph` sin duplicados ni variantes
  contradictorias.
