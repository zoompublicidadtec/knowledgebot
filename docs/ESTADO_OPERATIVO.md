...
| **Adjuntos en el panel** | 🟢 **ver: resuelto el 02-ago**. Se ven foto, nota de voz, sticker (en pequeño), video y GIF. 🔴 **enviar: pendiente**. Desde el panel solo se puede mandar texto. La tubería de envío YA existe y está probada (es la que usa el bot para mandar fotos de producto): falta el botón y la función que sube el archivo. Sin selector de emojis, por decisión del dueño |
