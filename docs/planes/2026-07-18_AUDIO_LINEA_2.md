...
> ## 🗄️ Plan CERRADO y SUPERADO (2026-07-29)
>
> Lo que este plan buscaba (meta 1: responder pidiendo texto cuando falla la
> descarga; meta 2: que el error se vea) **está hecho**: el bot contesta
> *"Disculpa, no pude abrir el archivo de audio…"* y el fallo queda registrado.
>
> Lo que **no** se logró, y este plan no podía lograr: que el audio se descargue.
> Verificado el 2026-07-29, el puente sigue devolviendo `ERROR descargando media
> (type=ptt): [Error] r || r` en cada intento, y lo guardado queda con
> `"media": null, "mediaError": true`. **Afecta a las dos líneas, no solo a
> `linea_2`**, y afecta igual a las imágenes.
>
> Consecuencia importante: como el archivo nunca existe, **tampoco se puede ver
> ni oír en el panel** ni llega al bucket de Cloudflare R2. No es un fallo de la
> vista de conversaciones.
>
> Es un bug de `whatsapp-web.js` que no tiene arreglo desde el código de la app.
> La vía aprobada por el dueño (29-jul-2026) es **migrar el puente a Baileys**,
> que en la prueba del 22-jul descargó una imagen en 238 ms. Seguimiento en
> `docs/ESTADO_OPERATIVO.md` §4 y en `docs/REGISTRO_DE_CAMBIOS.md`.
>
> Se conserva por el diagnóstico de la causa raíz, que sigue siendo válido.
